...
![SoundFlow Soundboard](assets/screenshots/en/soundboard.png)
...
![SoundFlow App Stream](assets/screenshots/en/app_stream.png)
...
![SoundFlow Online Radio](assets/screenshots/en/radio.png)
...
![SoundFlow Voice FX](assets/screenshots/en/voice_fx.png)
...
![SoundFlow Text-to-Speech](assets/screenshots/en/tts.png)
...
> 📁 **[Скриншоты с русскоязычным интерфейсом доступны в папке `assets/screenshots/ru/`](assets/screenshots/ru/)**
...
![Саундборд SoundFlow](assets/screenshots/en/soundboard.png)
...
![Стрим приложений](assets/screenshots/en/app_stream.png)
...
![Интернет-радио](assets/screenshots/en/radio.png)
...
![Голосовые эффекты](assets/screenshots/en/voice_fx.png)
...
![Синтез речи TTS](assets/screenshots/en/tts.png)
